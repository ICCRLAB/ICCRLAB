    ...
    $(document).ready(function () {
        ...
        <div class="row row-content">
          ...
          <div class="col-12 col-sm col-md mb-0 text-center">
            ...
            <h2 style="font-size:1.8rem";text-transform:uppercase">Jointly Organized by:                  Suleyman Demirel University, Turkey & Isparta Applied Sciences University, Turkey</h2>
